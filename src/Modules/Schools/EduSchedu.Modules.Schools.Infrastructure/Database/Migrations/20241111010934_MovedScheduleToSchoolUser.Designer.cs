...
namespace EduSchedu.Modules.Schools.Infrastructure.Database.Migrations
{
    ...
    [Migration("20241111010934_MovedScheduleToSchoolUser")]
    partial class MovedScheduleToSchoolUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduSchedu.Modules.Schools.Domain.Users.Schedule", b =>
                {
                    b.HasOne("EduSchedu.Modules.Schools.Domain.Users.SchoolUser", "SchoolUser")
                        .WithOne("Schedule")
                        .HasForeignKey("EduSchedu.Modules.Schools.Domain.Users.Schedule", "SchoolUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
