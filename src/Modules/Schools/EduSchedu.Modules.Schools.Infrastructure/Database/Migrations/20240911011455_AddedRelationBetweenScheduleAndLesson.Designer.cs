...
namespace EduSchedu.Modules.Schools.Infrastructure.Database.Migrations
{
    ...
    [Migration("20240911011455_AddedRelationBetweenScheduleAndLesson")]
    partial class AddedRelationBetweenScheduleAndLesson
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EduSchedu.Modules.Schools.Domain.Users.Schedule", b =>
                {
                    ...
                    b.OwnsMany("EduSchedu.Modules.Schools.Domain.Schools.Ids.LessonId", "LessonIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.ToTable("ScheduleLessonIds", "schools");
